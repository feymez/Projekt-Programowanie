...
> - **Obrazy** - obrazy które program wykorzystuje są zapisane w jego plikach. Niestety może zdarzyć się tak, że obrazy pobrane z GitHuba zostaną uszkodzone co będzie skutkowało wyłączaniem się programu w momencie próby otwarcia takiego obrazu. W takim wypadku dorzuciłem plik .rar z całym programem (EXE) gdzie obrazy nie są uszkodzone.
